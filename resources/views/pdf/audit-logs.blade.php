...
<head>
    ...
    <style>
        ...
        th, td { border: 1px solid #d9d9d9; padding: 4px; text-align: left; vertical-align: top; }
...
<body>
    ...
    <p>Filter: Modul={{ $filters['modul'] ?: 'semua' }}, Dari={{ $filters['date_from'] ?: '-' }}, Sampai={{ $filters['date_to'] ?: '-' }}, Cari={{ $filters['q'] ?: '-' }}</p>
    ...
    <table>
        ...
        @empty
            <tr><td colspan="6">Belum ada data log.</td></tr>
        @endforelse
        </tbody>
    </table>
